...
const
  ...
  meta = {
    get() { return new Promise( async ( resolve, reject ) => 
      axios
      .get( `meta` )
  ...
  events = {
    ...
    get( slug ) { return new Promise( ( resolve, reject ) => {
      axios
      .get( `events`, { params: `filters[slug][$eq]=${ slug }` } )
      .then( result => {
  ...
  viewers = { 
    get( uuid ) { return new Promise( ( resolve, reject ) => 
      axios 
