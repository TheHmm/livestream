...
<script>
export default { name:  "AccessibilityIcon" }
</script>
...
<template>
  ...
  >
    <g>
      <path 
        class="st0" 
        d="M833.6,367.6c-7.8-8-18.6-12.2-29.7-11.5l-134,7.5l73.7-84c10.5-12,13.5-27.9,9.4-42.2
      ...
      <path 
        class="st0"
        d="M762.4,203c35.5,0,64.3-28.8,64.3-64.3c0-35.5-28.8-64.3-64.3-64.3c-35.5,0-64.3,28.8-64.3,64.3
        C698.1,174.2,726.9,203,762.4,203z"
      />
      <path 
        class="st0" 
        d="M535.8,650.9c-69.7,0-126.3-56.7-126.3-126.3c0-26.3,8.1-50.7,21.8-70.9l-50.2-50.2
